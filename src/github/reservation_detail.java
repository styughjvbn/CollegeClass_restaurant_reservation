...
public class reservation_detail extends JPanel {
	...
	public reservation_detail() {
		...
		datebox.setFont(new Font("SEBANG Gothic", Font.PLAIN, 15));
		...
		detail_back.setFont(new Font("SEBANG Gothic", Font.BOLD, 17));
		...
		checkbutton.setFont(new Font("SEBANG Gothic", Font.BOLD, 17));
		...
		table_size_3.setFont(new Font("SEBANG Gothic", Font.BOLD, 15));
		...
		table_size_2.setFont(new Font("SEBANG Gothic", Font.BOLD, 15));
		...
		table_number_1.setFont(new Font("SEBANG Gothic", Font.BOLD, 15));
